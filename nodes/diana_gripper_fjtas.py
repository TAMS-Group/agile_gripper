...
class DianaGripperFollowJointTrajectoryAction( object ):
    ...
    def execute_callback( self, goal ):
        ...
        self.feedback.header.frame_id = "diana_gripper_fjtas"
        ...
        while t_now < t_end:
            ...
            if ii != last_feedback_ii:
                ...
                self.feedback.desired.accelerations = copy.deepcopy( four_zeros ) 
                self.feedback.desired.effort = copy.deepcopy( four_zeros )
                ...
                self.feedback.error.accelerations = copy.deepcopy( four_zeros )
                self.feedback.actual.effort = copy.deepcopy( four_zeros )
                self.feedback.error.time_from_start = rospy.Time.now()
...
if __name__ == '__main__':
    ...
    fjtas = DianaGripperFollowJointTrajectoryAction( "/diana_gripper_controller/follow_joint_trajectory" )
