...
// the diana_gripper has four SCS-20 servos: LFJ1 LFJ2 RFJ1 RFJ2
// 
#define N_JOINTS  (4)
#define N_SERVOS  (4)
...
int    servo_torque_limits[ N_SERVOS ]  = {    512,   512,       512,    512  }; // not yet used
...
void setup()
{
  ...
  //
  init_neopixel_ring();
  neopixel_single_color( 100, 100, 100 );

  // Neopixel animation and some wait to allow manual shutdown when first testing
  // on the real hardware...
  // 
  Serial.println( "Initial animation and sleep (3000 msec) to allow manual shutdown..." );
